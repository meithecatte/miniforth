...
At this moment, not counting the `55 AA` signature at the end, **506** bytes are used,
leaving 4 byte for any potential improvements.

*Thanks to Ilya Kurdyukov for saving **15** bytes!*
